    ...
    <View style={[styles.container,{backgroundColor:activeColors.bgcolor}]}>
      <View style={styles.profileDetails}>
        ...
        <View style={{flexDirection:'row'}}>
          <Text style={[styles.name,{color:activeColors.TextColor}]}>{post.createdBy.lastName}</Text>
        ...
        <View style={[styles.detailBox, {backgroundColor:activeColors.bgcolor}]}>
           <View style={[styles.detailItem,{borderBottomWidth:1, borderBottomColor:'gray', paddingBottom:10,}]}>
                <Text style={[styles.itemsText,{color:activeColors.TextColor}]}>Names</Text>
                  <Text style={[styles.subItemsText, {marginLeft:'auto',}]}>{post.createdBy.lastName}</Text>
           </View>
           
           <View style={[styles.detailItem,{borderBottomWidth:1, borderBottomColor:'gray', paddingBottom:10,}]}>
                <Text style={[styles.itemsText,{color:activeColors.TextColor}]}>Gender</Text>
                  <Text style={[styles.subItemsText, {marginLeft:'auto'}]}>{post.createdBy.gender}</Text>
           </View>

           <View style={[styles.detailItem,{borderBottomWidth:1, borderBottomColor:'gray', paddingBottom:10,}]}>
              <Text style={[styles.itemsText,{color:activeColors.TextColor}]}> Preferred Currency</Text>
               <Text style={[styles.subItemsText,{marginLeft:'auto'}]}>{post.createdBy.preferredCurrency}</Text>
           </View>
           <>
      ...
      <Text style={styles.listItem}>• Others</Text>
          ...
          <Text style={[styles.Titles2,{color:activeColors.TextColor}]}>Verifications</Text>
           ...
           <TouchableOpacity onPress={()=> navigation.navigate('Edit my profile', { Id: post.createdBy._id, post })} disabled={verifiedProfile} >
           <View style={[styles.detailItem,{borderBottomWidth:1, borderBottomColor:'gray', paddingBottom:10,}]}>
        ...
        <View style={styles.memberSince}>
          <Text style={styles.memberSinceText}>Member Since {post.createdBy.memberSince}</Text>
        </View>
        </View>
        </View>
        </ScrollView>
